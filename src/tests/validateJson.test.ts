...
describe('validateJson', () => {
  ...
  it('should return false when there is not the active property in the JSON', () => {
    const data =
      '{"course":"ofimática","units":[{"id":1,"title":"conceptos basicos"},{"id":2,"title":"tablas de unidades"},{"id":3,"title":"correcion ortografica"}]}'
    const resultJson = JSON.parse(validateJson(data))
    expect(resultJson.isValid).toBe(false)
    expect(resultJson.message).toBe(
  ...
  it('should return false when there is not id in a units', () => {
    const data =
      '{"course":"ofimática","units":[{"title":"conceptos basicos"},{"title":"tablas de unidades"},{"title":"correcion ortografica"}],"active":2}'
    const resultJson = JSON.parse(validateJson(data))
    expect(resultJson.isValid).toBe(false)
    expect(resultJson.message).toBe(
  ...
  it('should return false if the id is no active', () => {
    const data =
      '{"course":"ofimática","units":[{"id":1,"title":"conceptos basicos"},{"id":2,"title":"tablas de unidades"},{"id":3,"title":"correcion ortografica"}],"active":4}'
    const resultJson = JSON.parse(validateJson(data))
    expect(resultJson.isValid).toBe(false)
  ...
  it('should return false if does not have a title', () => {
    const data =
      '{"course":"ofimática","units":[{"id":1,"title":"conceptos basicos"},{"id":2,"title":"tablas de unidades"},{"id":3}],"active":2}'
    const resultJson = JSON.parse(validateJson(data))
    expect(resultJson.isValid).toBe(false)
    expect(resultJson.message).toBe(
  ...
  it('should return false if the course title is empty', () => {
    const data =
      '{"course":"","units":[{"id":1,"title":"conceptos basicos"},{"id":2,"title":"tablas de unidades"},{"id":3,"title":"correcion ortografica"}],"active":2}'
    const resultJson = JSON.parse(validateJson(data))
    expect(resultJson.isValid).toBe(false)
